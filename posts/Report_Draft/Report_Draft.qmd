...
![](/images/demographics/house_age.png){width="498"}

![](/images/demographics/house_value_by_year.png){width="498"}
...
![](/images/demographics/value_and_year_built.png){width="498"}
...
-   [**Vanguard**](https://investor.vanguard.com/corporate-portal?cmpgn=BR:PS:XXX:BR:11082021:GS:DM:BD_KeywordAdvice_EXM:RTG:Home:Home:Ad&gclid=EAIaIQobChMIuueyi6aEgAMV8G5vBB36swgREAAYASAAEgKvf_D_BwE&gclsrc=aw.ds){target="_blank"}

    Vanguard is an investment management company that offers a wide range of financial products and services. It provides investors with access to mutual funds, ETFs, stocks, bonds, and retirement accounts, focusing on low-cost investing and providing tools and resources for financial planning.
...
-   Based on the images sources used in this project, which are Kaggle, Google Street View, Zillow, Vanguard, Beacon, County Assessor Office/websites, the best image source is **Beacon,** second best is **Google**.

    In Year 2, utilize all the sources but consider using spider to scrape from Zillow, Beacon and Vanguard.
...
-   **Image Classification for Model Training**
    ...
    |                                                    |                                          |
    |-----------------------------------------|----------------------------------------|
    | **If Image Classification,**                       | **Recommendations**                      |
...
-   Tools used for geocoding are QGIS and R, use python for geocoding to check if it will be better than the two used in the project.
