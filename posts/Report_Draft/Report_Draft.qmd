...
-   Based on the images sources used in this project, which are Kaggle, Google Street View, Zillow, Vanguard, Beacon, County Assessor Office/websites, the best image source is **Beacon,** second best is **Google**.
    ...
    For Year 2, use all sources but look into using spider to scrape from Zillow, Beacon and Vanguard.
...
-   Harness the power of ChatGPT but do not fully trust it. The most productive way to use ChatGPT for coding is when you know exactly what should be happening and you just need a crutch to get there. General AI models the chatbot is somewhat helpful in debugging.
